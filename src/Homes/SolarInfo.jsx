    ...
    >
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold leading-tight text-yellow-400">
          Transform Your Home with Galo Solar
        </h1>
        <p className="mt-4 text-lg text-gray-300">
          Under the PM Surya Ghar Scheme, enjoy substantial subsidies as you
          transition to eco-friendly and cost-effective solar energy solutions.
        </p>
      </div>
